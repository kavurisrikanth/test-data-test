...
const double _kMinLoaderSize = 20.0;
...
abstract class ProgressIndicator extends StatefulWidget {
  ...
  Color _getBackgroundColor(BuildContext context) =>
      backgroundColor ?? HexColor.fromHex('1b8cff');
  Color _getValueColor(BuildContext context) =>
      valueColor?.value ?? HexColor.fromHex('1b8cff');
...
/// See also:
///
///  * [Loader], which shows progress along a circular arc.
///  * [RefreshIndicator], which automatically displays a [Loader]
...
class _LoaderPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_LoaderPainter oldPainter) {
    return oldPainter.backgroundColor != backgroundColor ||
        oldPainter.valueColor != valueColor ||
        oldPainter.value != value ||
...
class Loader extends ProgressIndicator {
...
class _LoaderState extends State<Loader> with SingleTickerProviderStateMixin {
  ...
  Widget _buildIndicator(BuildContext context, double headValue,
    ...
    return widget._buildSemanticsWrapper(
      ...
      child: Container(
        constraints: const BoxConstraints(
          minWidth: _kMinLoaderSize,
          minHeight: _kMinLoaderSize,
        ),
        child: CustomPaint(
...
class _RefreshProgressIndicatorPainter extends _LoaderPainter {
...
///  * [RefreshIndicator], which automatically displays a [Loader]
///    when the underlying vertical scrollable is overscrolled.
class RefreshProgressIndicator extends Loader {
  ...
  const RefreshProgressIndicator({
    ...
    Color backgroundColor,
    Animation<Color> valueColor,
    double strokeWidth = 2.0, // Different default than Loader.
    String semanticsLabel,
    String semanticsValue,
  }) : super(
          key: key,
...
class _RefreshProgressIndicatorState extends _LoaderState {
  ...
  Widget _buildIndicator(BuildContext context, double headValue,
      double tailValue, int stepValue, double rotationValue) {
    final double arrowheadScale = widget.value == null
        ? 0.0
        : ((widget.value * 2.0).clamp(0.0, 1.0) as double);
    return widget._buildSemanticsWrapper(
      context: context,
      child: Container(
