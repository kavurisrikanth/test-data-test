...
class _ColorPickerState extends State<ColorPickerNative> {
  ...
  initState() {
    ...
    _hexaColorController.text = HexColor.toHex(_shadedColor);
  }
  ...
  Color _calculateShadedColor(double position) {
    ...
    setState(() {
      _hexaColorController.text = HexColor.toHex(color);
    });
  ...
  void onHexCodeChanges(String text) {
    Color hexCodeColor = HexColor.fromHex(text);
      ...
      child: ColorPickerArea(
        ...
        (HSVColor color) {
          setState(() {
            ...
            _hexaColorController.text = HexColor.toHex(_currentColor);
          });
