...
import '../rocket/TemplateTypes.dart';
...
class JSONUtils {
  ...
  static DBObject _fromRefJson(Map obj) {
    ...
    int type = Template.typeInt(obj['__typename']);
    DBObject res = catche.findObject(type, obj['id']);
    if (res == null) {
      res = Template.types[type].creator();
      res.id = obj['id'];
