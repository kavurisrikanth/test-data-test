...
class InputFieldHelper {
  ...
  static EdgeInsets getPaddingInfo(bool dense) {
    if (dense) {
  ...
  static Color getDefaultBorderColor() {
    return HexColor.fromHex('bfbfbf');
  }
  ...
  static TextStyle validateTextStyle(TextStyle textStyle) {
    if (textStyle != null) {
      ...
      return TextStyle(color: HexColor.fromHex('262626'));
    }
  }
  ...
  static Color getActiveBorderColor(Color cursorColor) {
    if (cursorColor != null) {
      ...
      return HexColor.fromHex('14acff');
    }
  }
  ...
  static TextStyle getErrorTextStyle() {
    return TextStyle(color: HexColor.fromHex('ff0000'), fontSize: 10.0);
  }
}
